...
const NAMESPACE = 'bmi-component-stencil';
...
const patchBrowser = async () => {
    ...
    // @ts-ignore
    const importMeta = (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('core-560a2fbb.js', document.baseURI).href));
