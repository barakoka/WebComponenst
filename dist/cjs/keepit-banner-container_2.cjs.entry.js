...
const KeepitBannerComponent = class {
    constructor(hostRef) {
        ...
        this.redirect = core.createEvent(this, "redirect", 7);
        this.toggleBunner = core.createEvent(this, "toggleBunner", 7);
    }
    makeOpen() {
...
const SideDrawer = class {
    ...
    render() {
        ...
        if (this.showContact) {
            mainContent = (core.h("div", { id: "contact-information" }, core.h("h2", null, "Contact Information"), core.h("p", null, "Your cant reach us via phone or email."), core.h("ul", null, core.h("li", null, "Phone: 1234567890"), core.h("li", null, "Email:", core.h("a", { href: "mailto:something@something.com" }, "something@something.com")))));
        }
        let content = (core.h("aside", null, core.h("header", null, core.h("button", { onClick: this.onCloseDrawer.bind(this) }, "X"), core.h("h1", null, this.titleName)), core.h("section", { id: "tabs" }, core.h("button", { class: this.showContact ? '' : 'active', onClick: this.onContentChange.bind(this, 'nav') }, "Navigation"), core.h("button", { class: this.showContact ? 'active' : '', onClick: this.onContentChange.bind(this, 'contact') }, "Contact")), core.h("main", null, mainContent)));
        return content;
    }
...
exports.keepit_banner_container = KeepitBannerComponent;
exports.keepit_side_drawer = SideDrawer;
